...
from keras.layers import GlobalAveragePooling2D, Permute, multiply, Dense, Reshape, add, Lambda
...
class MultiGraphConvolution(Layer):
    """Graph convolution layer."""
    def __init__(self, input_dim, output_dim, placeholders, dropout=0.,
                 sparse_inputs=False, act=tf.nn.relu, bias=False,
                 featureless=False, **kwargs):
        super(MultiGraphConvolution, self).__init__(**kwargs)
    ...
    def _call(self, inputs):
        ...
        supports_att = view_attention_block(temp_output, 2)

        supports_att = Lambda(squeeze_tensor_dim_l)(supports_att)
